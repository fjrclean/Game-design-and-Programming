#include <math.h>
#include "dependency\GL\include\glut.h"
#include "dependency\GL\include\freeglut.h"
#include "dependency\SDL2\include\SDL.h"
#undef main
#include <time.h>
...
// varibles used for translating graphics etc
...
void myinit()
{
	...
	//glClearColor(97.0/255.0, 140.0/255.0, 185.0/255.0, 1.0);        //ORIGINAL
	glClearColor(97.0 , 140.0 , 185.0 , 1.0);
...
void DisplayChancPosts ()
{
	...
	//variable declaration for counting CHRISTOPH PICKETT
	int i; 
...
void DisplayAboveWindowBlock ()
{
	...
	glCallList(213);
	glPushMatrix();
		glTranslated(0.0f, 1024.0f, 0.0f);
		glCallList(213);
	glPopMatrix();
...
void DrawAboveWindowBlock ()
{
	...
	glNewList(232, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(31768.0f + 45, 11162, 41011.2f - 45);
			glTexCoord2d(10.54f, 0.0f);
			glVertex3d(33848+ 45, 11920, 43095.2f -45 );
			glTexCoord2d(10.54f, 1.0);
			glVertex3d(33848.0f - 45, 11920, 43095.2f +45);
	...
	glNewList(233, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glTexCoord2d(10.54f, 0.0f);
			glVertex3d(33848- 45, 11920, 43095.2f +45 );
			glTexCoord2d(10.54f, 0.75f);
			glVertex3d(33848.0f - 45, 11920 +192, 43095.2f +45);
			glTexCoord2d(0.0, 0.75);
			glVertex3d(31768.0f - 45, 11162 +192, 41011.2f + 45);
		glEnd();
	glEndList();
	...
	glNewList(234, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(31768.0f + 45, 11162, 41011.2f - 45);
			glTexCoord2d(10.54f, 0.0);
			glVertex3d(33848+ 45, 11920, 43095.2f -45 );
			glTexCoord2d(10.54f, 0.75f);
			glVertex3d(33848.0f + 45, 11920 +192, 43095.2f -45);
			glTexCoord2d(0.0f, 0.75f);
			glVertex3d(31768.0f + 45, 11162 +192, 41011.2f - 45);
		glEnd();
	glEndList();
...
void DisplayPhysSciPosts ()
{
	...
	//variable declarations CHRISTOPH PICKETT
	int i;
...
void DrawPhysSciPosts ()
{
	...
	glNewList(41, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glTexCoord2d(0.0f, 0.315f);
			glVertex3d(33808.0f, 10288.0f, 38239.0f + (1024.0f * 0.315f));
			glTexCoord2d(1.0f, 0.315f);
...
void DisplayPavement ()
{
	...
	//variable declaration CHRISTOPH PICKETT
